...
from bot.language.translator import translator_hub
from bot.middlewaries.db import DbSessionMiddleware

from config import load_config, Config
from bot.middlewaries.translator import TranslatorMD
...
async def main() -> None:
    ...
    dp.workflow_data.update({'redis': redis, "_translator_hub": t_hub, "config": config})
